...
- **Zoom**: drag the background to **pan**; the **mouse wheel** over a plot zooms the **ω axis**, while the wheel over an axis (the margins holding the labels) scales **only that axis** — magnitude/phase vertically, ω horizontally.
